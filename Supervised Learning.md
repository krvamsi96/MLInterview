...
![](https://github.com/theainerd/MLInterview/blob/master/images/decision-forests-and-discriminant-analysis-77-638.jpg)
 ...
 ## The differences are as Ran and tree:

1) Decision tree- on taining data set,decision tree is more accurate Random forest-for unexpected validation of data,random forest is more accurate.

2) decision tree-build several decision trees and find out the output

Random forest-randomly select observations

3)decision tree-collection of variables or attributes or datasets

Random forest-collection of decision tree

4) decision tree-suffer from overfitting

Random forest-prevents overfitting

5)decision tree-on the given training dataset,first data are checked and validated

Random forest-uses invalidated data
